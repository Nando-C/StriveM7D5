...
import { Button, Col, ListGroup, Nav } from 'react-bootstrap'
                    ...
                    <div className='main-container mt-4'>
                        ...
                        <Nav variant="pills" defaultActiveKey="/home" className="ml-3 flex-column">
                            ...
                            <Nav.Link eventKey="link-2" className='d-flex nav-link' to='/'>
                                ...
                                <span className='ml-3'><small>Search</small></span>
                            </Nav.Link>
                            <Nav.Link eventKey="link-3" className='d-flex nav-link' to='/'>
                                ...
                                <span className='ml-3'><small>Your Library</small></span>
                            </Nav.Link>
                            {/* <Nav.Link eventKey="link-4">Link</Nav.Link> */}
                            <div className='mt-5'>
                                <div id='menu-button' className='d-flex'>
                                        <div >
                                            <div id='plus-icon'>
                                                <svg role="img" height="12" width="12" viewBox="0 0 16 16" class="Svg-sc-1bi12j5-0 fIDrcz"><path d="M14 7H9V2H7v5H2v2h5v5h2V9h5z"></path><path fill="none" d="M0 0h16v16H0z"></path></svg>
                                            </div>
                                        </div>
                                        <span><small><strong>Create Playlist</strong></small></span>
                                </div>
                                <div id='menu-button' className='d-flex'>
                                        <div >
                                        <div id='heart-songs-icon'>
                                            <svg role="img" height="12" width="12" viewBox="0 0 16 16" class="Svg-sc-1bi12j5-0 fIDrcz"><path fill="none" d="M0 0h16v16H0z"></path><path fill="white" d="M13.797 2.727a4.057 4.057 0 00-5.488-.253.558.558 0 01-.31.112.531.531 0 01-.311-.112 4.054 4.054 0 00-5.487.253c-.77.77-1.194 1.794-1.194 2.883s.424 2.113 1.168 2.855l4.462 5.223a1.791 1.791 0 002.726 0l4.435-5.195a4.052 4.052 0 001.195-2.883 4.057 4.057 0 00-1.196-2.883z"></path></svg>
                                        </div>
                                        </div>
                                        <span><small><strong>Liked Songs</strong></small></span>
                                </div>
                            </div>
