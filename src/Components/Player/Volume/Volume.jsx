...
import { setCurrentVolume } from "../../../redux/slices/currentSong";
import "./Volume.css";
...
const Volume = () => {
  ...
  const volumeBar = useRef(); // reference our audio bar input
  ...
  const changeVolume = () => {
    dispatch(setCurrentVolume(volumeBar.current.value));
    volumeBar.current.style.setProperty(
      "--seek-before-width",
